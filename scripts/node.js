...
export function GetNeighbours(q, row, col, grid) {
	...
	if (rightNode !== undefined && (rightNode.getisNotVisited() || rightNode.getisEnd())) {
		q.push(rightNode);
	}
	if (upNode !== undefined && (upNode.getisNotVisited() || upNode.getisEnd())) {
		q.push(upNode);
	}
	if (leftNode !== undefined && (leftNode.getisNotVisited() || leftNode.getisEnd())) {
		q.push(leftNode);
	}
	if (downNode !== undefined && (downNode.getisNotVisited() || downNode.getisEnd())) {
		q.push(downNode);
	}
}
...
export function GetWeightedNeighbours(q, row, col, grid) {
	...
	if (rightNode !== undefined && !rightNode.getisWall() && !rightNode.getisVisited()) {
		q.push(rightNode);
	}
	if (upNode !== undefined && !upNode.getisWall() && !upNode.getisVisited()) {
		q.push(upNode);
	}
	if (leftNode !== undefined && !leftNode.getisWall() && !leftNode.getisVisited()) {
		q.push(leftNode);
	}
	if (downNode !== undefined && !downNode.getisWall() && !downNode.getisVisited()) {
		q.push(downNode);
	}
}
